    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.right_trigger > 0.1 && mineralSenderPosition <= senderOpenLimitPoint) {
                ...
                if (mineralSenderPosition < 0) {
                    robot.mineralSend.setPower(0.5);
                } else {
            ...
            if (-gamepad2.right_stick_y > 0.2) {
                ...
                robot.blockMineralServo.setPosition(robot.block);
            } else if (-gamepad2.right_stick_y < -0.2 && pushPosition > 0 /* &&  pushPosition<4400 */) {
            ...
            if (-gamepad2.left_stick_y < 0 && liftPosition > 60) {
            ...
            } else if (gamepad2.dpad_up && climbPosition < 23100) {
